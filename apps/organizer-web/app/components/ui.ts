...
export const playerCardClass =
  'aspect-square bg-gradient-to-br from-navy-mid to-navy-deep rounded-2xl border border-gold/40 shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-[0_10px_20px_rgba(12,24,48,0.3)] hover:border-gold/70 flex flex-col items-center justify-center gap-2.5 p-4 text-center';
